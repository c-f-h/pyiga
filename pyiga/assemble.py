...
class MultiBasis:
    ...
    def set_subspace(self, subspace='C0'):
        ...
        self.R_related = scipy.sparse.coo_matrix((np.ones(len(I)),(np.arange(len(I)),I)),shape=(len(I),self.N_ofs[-1]))
    ...
    def p_refine(self, p_inc=1, return_P = False, in_subspace=True):
