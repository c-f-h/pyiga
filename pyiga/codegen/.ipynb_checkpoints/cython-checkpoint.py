...
class AsmGenerator(CodegenVisitor):
    ...
    def generate_init(self):
        ...
        self.putf( 'def __init__(self, {kvs}, {inp}{bbox}{boundary}, quadorder=None):', kvs=', '.join(used_kvs),
        ...
        self.putf('self.nqp = quadorder if quadorder is not None else max([kv.p for kv in {kvs}]) + 1', kvs=' + '.join(used_kvs))
